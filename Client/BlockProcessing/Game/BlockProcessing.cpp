...
#include "BlockProcessing/Game/Debug/Performance/SpeedTester.h"
...
void BlockProcessing::init(GLFWwindow* window, int width, int height) {
    ...
    interfaceManager.add(&chatInterface);
    interfaceManager.add(&debugInterface);
    interfaceManager.add(&crosshairInterface);
