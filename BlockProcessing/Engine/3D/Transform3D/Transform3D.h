...
public:
    ...
    Transform3D(float x, float y, float z, float angle, const Vec3f& axis, float size);
    Transform3D(float x, float y, float z, float sizeX, float sizeY, float sizeZ);
    Transform3D(float x, float y, float z, float size);
    Transform3D(const Vec3f& position, float angle, float axisX, float axisY, float axisZ, float size);
    Transform3D(const Vec3f& position, float angle, const Vec3f& axis, float size);
    Transform3D(const Vec3f& position, float size);
    Transform3D(const Vec3f& position, float sizeX, float sizeY, float sizeZ);
    ...
    inline Vec3f getPosition() const { return Vec3f(x, y, z); }
